...
class LibrariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create library" do
    assert_difference("Library.count") do
      post libraries_url, params: { library: { address: @library.address, name: @library.name, owner: @library.owner } }
    end
  ...
  test "should update library" do
    patch library_url(@library), params: { library: { address: @library.address, name: @library.name, owner: @library.owner } }
